...
import { TEMPORADAS, EXPERIENCIA_ORDER, EXPERIENCIAS, WHATSAPP_BASE } from '../data/japonData'
import TOURS, { TOUR_ORDER } from '../data/tourData'
import FallingElements from '../components/FallingElements'
import './pages.css'

/**
 * TemporadaToursLanding — Seasonal tours landing page matching the format of /viajes/corea.
 * Route: /temporadas/:temporada (e.g. /temporadas/primavera, /temporadas/verano, /temporadas/otono, /temporadas/invierno)
 */
export default function TemporadaToursLanding() {
    ...
    return (
        <>
            ...
            {/* ===== 3. TOURS SECTION (O FALLBACK A LA CARTA SI NO HAY TOURS) ===== */}
                    ...
                    {seasonalTours.length > 0 ? (
                        ...
                        >
                            ...
                            <div style={{ display: 'flex', gap: '14px', justifyContent: 'center', flexWrap: 'wrap' }}>
                                <Link
                                    to={`/viajes/japon/${seasonKey}`}
                                    className="btn btn-primary"
                                    style={{ padding: '14px 28px', borderRadius: '100px', fontWeight: '800' }}
                                >
                                    ⛩️ Ver Modalidades a la Carta ({season.name}) →
                                </Link>
                                <a
            ...
            <section style={{ backgroundColor: '#111827', color: '#fff', padding: '5rem 0' }}>
                <div className="container" style={{ maxWidth: '860px', textAlign: 'center' }}>
                    ...
                    <p style={{ fontSize: '1.05rem', color: '#cbd5e1', lineHeight: 1.7, margin: '0 0 32px' }}>
                        Explora las 4 modalidades de <strong>Japón a la Carta</strong> (Libre, Esencial, Completo y Signature) para viajar en {season.name} a tu manera.
                    </p>
                    <div style={{ display: 'flex', gap: '14px', justifyContent: 'center', flexWrap: 'wrap' }}>
                        <Link
                            to={`/viajes/japon/${seasonKey}`}
                            ...
                            style={{ padding: '14px 28px', borderRadius: '100px', fontWeight: '750' }}
                        >
                            🌸 Explorar Japón a la Carta ({season.name})
                        </Link>
                        <a
