...
const TRIPS = [
    ...
    { id: 'corea-otono-2026', title: 'Corea en Otoño', excerpt: '12 días viviendo la magia del otoño en Corea del Sur. Seúl, Busan y Gyeongju.', date: '27 octubre – 7 noviembre', duration: '12 días', flagIcons: [{ code: 'kr', name: 'Corea' }], badge: '🍁 Otoño 2026', soldOut: false, image: 'https://images.unsplash.com/photo-1548115184-bc6544d06a58?w=600&h=400&fit=crop', includes: ['10 noches con desayuno', 'Tours y entradas con guía', 'Transportación y KTX', 'Coordinador 24/7 y Wi-Fi'] },
]
