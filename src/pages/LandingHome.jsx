...
const TRIPS = [
    { id: 'sakura-2026', title: 'Sakura 2026', excerpt: 'Cerezos en flor, templos milenarios y la esencia más pura de Japón. 12 días inolvidables.', date: '23 marzo – 3 abril', duration: '12 días', flagIcons: [{ code: 'jp', name: 'Japón' }], badge: 'SOLD OUT', soldOut: true, image: 'https://images.unsplash.com/photo-1522383225653-ed111181a951?w=600&h=400&fit=crop', includes: ['Vuelos desde CDMX', 'Hospedaje incluido', 'JR Pass incluido', 'Guía hispanohablante'] },
    { id: 'japon-corea-mayo-2026', title: 'Japón y Corea', excerpt: '14 días explorando lo mejor de dos mundos: tradición japonesa y cultura coreana.', date: '17 – 30 mayo', duration: '14 días', flagIcons: [{ code: 'jp', name: 'Japón' }, { code: 'kr', name: 'Corea' }], badge: 'SOLD OUT', soldOut: true, image: 'https://images.unsplash.com/photo-1480796927426-f609979314bd?w=600&h=400&fit=crop', includes: ['Vuelos desde CDMX', 'Hospedaje incluido', 'JR Pass + KTX', 'Guía hispanohablante'] },
    { id: 'corea-junio-2026', title: 'Corea', excerpt: 'Palacios, K-culture, playas y la isla de Jeju. 12 días por Seúl, Busan y Jeju.', date: '1 – 12 junio', duration: '12 días', flagIcons: [{ code: 'kr', name: 'Corea' }], badge: '¡Últimos lugares!', image: 'https://images.unsplash.com/photo-1723174391648-9e73f8865a12?w=600&h=400&fit=crop', includes: ['Vuelos desde CDMX', 'Hospedaje incluido', 'KTX incluido', 'Guía hispanohablante'] },
    { id: 'verano-japon-2026', title: 'Verano en Japón', excerpt: 'Festivales de verano, fuegos artificiales y la cultura japonesa en su máximo esplendor.', date: 'Julio 2026', duration: '14 días', flagIcons: [{ code: 'jp', name: 'Japón' }], badge: '☀️ Dos fechas', image: '/images/tours/verano-japon.jpg', includes: ['Vuelos desde CDMX', 'Hospedaje incluido', 'JR Pass incluido', 'Guía hispanohablante'] },
    { id: 'corea-septiembre-2026', title: 'Corea', excerpt: 'Seúl, Busan y Jeju en septiembre. El clima perfecto para explorar Corea del Sur.', date: '18 – 29 septiembre', duration: '12 días', flagIcons: [{ code: 'kr', name: 'Corea' }], image: 'https://images.unsplash.com/photo-1726859133123-51e9f46a23c6?w=600&h=400&fit=crop', includes: ['Vuelos desde CDMX', 'Hospedaje incluido', 'KTX incluido', 'Guía hispanohablante'] },
