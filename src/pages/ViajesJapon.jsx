...
/**
 * ViajesJapon — Japan trips landing page matching the format of /viajes/corea.
 * Route: /viajes/japon
 */
export default function ViajesJapon() {
    ...
    return (
        <>
            <Helmet>
                <title>Viajes a Japón desde México — Tours Grupales y a la Carta | RutaXAsia</title>
                <meta name="description" content="Descubre todos nuestros viajes a Japón desde México. Tokyo, Kyoto, Osaka, Monte Fuji. Tours grupales todo incluido y viajes a la carta con guía en español. RutaXAsia." />
            </Helmet>
            ...
            {/* ===== 4. SEASONS EXPLORER (LANDINGS POR TEMPORADA) ===== */}
            ...
            {/* ===== 5. JAPÓN A LA CARTA SHOWCASE CALLOUT ===== */}
            <section style={{ backgroundColor: '#111827', color: '#fff', padding: '5rem 0' }}>
                <div className="container" style={{ maxWidth: '960px', textAlign: 'center' }}>
                    ...
                    <p style={{ fontSize: '1.05rem', color: '#cbd5e1', lineHeight: 1.7, maxWidth: '720px', margin: '0 auto 32px' }}>
                        Diseña tu viaje soñado con las fechas, duración y experiencias que tú elijas. Ofrecemos modalidades <strong>Libre</strong>, <strong>Esencial</strong>, <strong>Completo</strong> y <strong>Signature</strong> con hoteles 3-4★, tren bala JR Pass y respaldo en español 24/7.
                    </p>
                    <div style={{ display: 'flex', gap: '14px', justifyContent: 'center', flexWrap: 'wrap' }}>
                        <Link to="/viajes/japon/sakura" className="btn btn-primary" style={{ padding: '14px 28px', borderRadius: '100px', fontWeight: '750' }}>
                            🌸 Diseñar Viaje a la Carta
                        </Link>
                        <a
