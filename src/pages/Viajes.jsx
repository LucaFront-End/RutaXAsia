...
const DESTINATIONS = [
    {
        ...
        excerpt: 'Diseña tu viaje a Japón a tu medida. Elige tu estación preferida (Sakura, Akari o Kamakura) y el estilo de viaje que más te guste (Libre, Esencial, Completo o Signature).',
        seasons: ['🌸 Sakura', '☀️ Akari', '🍁❄️ Kamakura'],
        available: true,
        isCarta: true,
    },
    {
