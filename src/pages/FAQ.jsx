                ...
                <div className="fq-layout">
                    ...
                    <aside className="fq-sidebar reveal-left">
                        ...
                        <div className="fq-sidebar-help">
                            ...
                            <a href="https://wa.me/525657929121?text=SW-Hola%20tengo%20una%20pregunta%20sobre%20los%20viajes" className="btn btn-primary btn-full" target="_blank" rel="noopener noreferrer" style={{fontSize:'0.85rem', padding:'0.7rem 1.2rem'}}>
            ...
            <section className="fq-cta">
                <div className="container">
                        ...
                        <div className="fq-cta-right">
                            <a href="https://wa.me/525657929121?text=SW-Hola%20quiero%20cotizar%20un%20viaje" className="btn btn-primary" target="_blank" rel="noopener noreferrer">
