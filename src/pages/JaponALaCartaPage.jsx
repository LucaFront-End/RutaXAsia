...
/**
 * JaponALaCartaPage — Dedicated "Japón a la Carta" interactive Trip Builder page.
 * Route: /japon-a-la-carta (and /viajes/a-la-carta)
 */
export default function JaponALaCartaPage() {
    useEffect(() => {
        window.scrollTo(0, 0)
    }, [])
    ...
    return (
        <>
            <Helmet>
                <title>Japón a la Carta — Diseña tu Viaje Personalizado | RutaXAsia</title>
                <meta name="description" content="Japón a la Carta: elige tu temporada, tus fechas y tu estilo de viaje. Libre, Esencial, Completo o Signature. Viajes a Japón desde México con hoteles 3-4★ y JR Pass." />
            </Helmet>
            ...
            <section className="jac-hero">
                <div className="jac-hero-bg">
                    <img
                        ...
                        alt="Japón a la Carta"
                    />
                    <div className="jac-hero-overlay" />
                </div>
                <div className="jac-hero-content container">
                    <span className="jac-hero-tag" data-animate="fade-up" data-delay="100">🇯🇵 Japón a la Carta</span>
            ...
            <section className="jac-cta">
                <div className="container" style={{ textAlign: 'center' }}>
                    ...
                    <p className="jac-cta-subtitle">
                        Y diseñamos tu experiencia a la medida contigo.
                    </p>
                    <a
                    ...
                    >
                        💬 Cotiza tu Viaje a Japón por WhatsApp
                    </a>
                </div>
            </section>
        </>
