...
const CITY_COORDINATES = {
    ...
    // --- Barrios de Tokio & Excursiones (Tokyo Barrios Map) ---
    'asakusa':        { lat: 35.7148, lng: 139.7967, label: 'Asakusa & Skytree', country: 'jp' },
    'skytree':        { lat: 35.7100, lng: 139.8107, label: 'Tokyo Skytree', country: 'jp' },
    'harajuku':       { lat: 35.6692, lng: 139.7042, label: 'Harajuku & Omotesando', country: 'jp' },
    'shinjuku':       { lat: 35.6938, lng: 139.7035, label: 'Shinjuku', country: 'jp' },
    'ginza':          { lat: 35.6719, lng: 139.7640, label: 'Ginza', country: 'jp' },
    'shibuya':        { lat: 35.6580, lng: 139.7016, label: 'Shibuya', country: 'jp' },
    'gotemba-fuji':   { lat: 35.3089, lng: 138.9348, label: 'Monte Fuji & Gotemba Outlets', country: 'jp' },
    'gotemba':        { lat: 35.3089, lng: 138.9348, label: 'Gotemba Outlets', country: 'jp' },
    'ueno':           { lat: 35.7140, lng: 139.7741, label: 'Ueno & Ameyoko', country: 'jp' },
    'akihabara':      { lat: 35.6983, lng: 139.7731, label: 'Akihabara', country: 'jp' },
    'tsukiji':        { lat: 35.6655, lng: 139.7708, label: 'Tsukiji Market', country: 'jp' },
    'kappabashi':     { lat: 35.7132, lng: 139.7897, label: 'Kappabashi Kitchen Town', country: 'jp' },
    'daikanyama':     { lat: 35.6489, lng: 139.7031, label: 'Daikanyama & Nakameguro', country: 'jp' },
    'nakameguro':     { lat: 35.6442, lng: 139.6988, label: 'Nakameguro', country: 'jp' },
    'ebisu':          { lat: 35.6467, lng: 139.7101, label: 'Ebisu', country: 'jp' },
    'ryogoku':        { lat: 35.6961, lng: 139.7928, label: 'Ryogoku (Hotel APA Tower)', country: 'jp' },
    'narita':         { lat: 35.7720, lng: 140.3929, label: 'Aeropuerto Tokio Narita', country: 'jp' },
    'cdmx':           { lat: 35.7720, lng: 140.3929, label: 'Vuelo CDMX – Tokio', country: 'jp' },
...
export const CITY_NAME_TO_KEY = {
    ...
    'Uji':                    'uji',
    // Tokyo Barrios
    'Asakusa & Tokyo Skytree':         'asakusa',
    'Asakusa & Skytree':               'asakusa',
    'Harajuku, Omotesando & Shinjuku': 'shinjuku',
    'Harajuku & Shinjuku':             'shinjuku',
    'Ginza & Shibuya':                 'shibuya',
    'Ginza & Shibuya Crossing':        'shibuya',
    'Monte Fuji & Gotemba Outlets':    'gotemba-fuji',
    'Monte Fuji + Gotemba Outlets':    'gotemba-fuji',
    'Kamakura & Yokohama':             'kamakura',
    'Kamakura + Yokohama':             'kamakura',
    'Ueno, Ameyoko & Akihabara':       'akihabara',
    'Ueno + Ameyoko + Akihabara':      'akihabara',
    'Tsukiji & Kappabashi':            'tsukiji',
    'Tsukiji Market & Kappabashi':     'tsukiji',
    'Tsukiji + Kappabashi':            'tsukiji',
    'Daikanyama, Nakameguro & Ebisu':  'ebisu',
    'Daikanyama + Nakameguro + Ebisu': 'ebisu',
    'Salida de México':                'narita',
    'Regreso a Ciudad de México':      'narita',
    // Korea
    'Seúl':                   'seoul',
    'Busan':                  'busan',
    'Jeju':                   'jeju',
