            ...
            <div className="container">
                <div className="footer-grid">
                    <div className="footer-brand">
                        <a href="#hero" className="navbar-brand footer-logo">
                    ...
                    <div className="footer-links">
                        <h4>Viajes</h4>
                        <ul>
                            <li><a href="#">Sakura I 2026</a></li>
                            <li><a href="#">Verano Japón 2026</a></li>
                            <li><a href="#">Corea 2026</a></li>
                            <li><a href="#">Otoño Japón 2026</a></li>
                            <li><a href="#">Japón Octubre 2026</a></li>
                        </ul>
                    </div>
